...
'use strict';
// Colour definitions:
var magenta = "#FF00FF"; // eslint-disable-line no-unused-vars
let blue = "#0000FF";// eslint-disable-line no-unused-vars
let green = "#008000";// eslint-disable-line no-unused-vars
let impBlue = "#003E74";// eslint-disable-line no-unused-vars
let black = "rgb(0,0,0)";// eslint-disable-line no-unused-vars
let white = "rgb(255,255,255)";// eslint-disable-line no-unused-vars
let cyan = "rgb(0,146,146)"; // eslint-disable-line no-unused-vars
let lilac = "rgb(182,109,255)"; // eslint-disable-line no-unused-vars
let orange = "rgb(219,209,0)"; // eslint-disable-line no-unused-vars
let orange2 = "rgb(240,150,0)"; // eslint-disable-line no-unused-vars
 ...
 */
function createView(point) {// eslint-disable-line no-unused-vars
 ...
 */
function createAxes(length) {// eslint-disable-line no-unused-vars
    var axes = [];
    var vector = [0, length];
    var initialVec;
    var vecString = ["x", "y", "z"];
...
function addText(data, textPosition=[0,0,0], text="", color="rgb(0,0,0)", size=16){ // eslint-disable-line no-unused-vars
 ...
 */
function Line(points) { // eslint-disable-line no-unused-vars
    this.x = [];
    this.y = [];
    this.z = [];
    ...
    this.arrowHead = function(color, width=7, wingLen=0.1, dash="solid") { // eslint-disable-line no-unused-vars
