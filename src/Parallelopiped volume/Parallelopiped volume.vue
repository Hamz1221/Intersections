    ...
    <div>
        <iv-visualisation :title="pageName" :vue_config="vue_config" :page_number="2">
            <div class="iv-welcome-message">
                ...
                <p> Your page, Parallelopiped volume has succesfully been set up using the multiPage CLI template!</p>
            </div>
        </iv-visualisation>
    </div>
</template>
...
export default {
    name:"parallelopiped_volume",
    data(){
        return {
            pageName:"Parallelopiped volume",
            vue_config
        }
    }
}
